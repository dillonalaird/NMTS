...
def process_files(trans_file, ref_file, skip_length=None):
  """
  ...
  if skip_length:
    ...
    for line in ref_lines:
      if len(line.split()) <= skip_length:
        ref_lines_new.append(line)
  ...
  # score
  return score_length(sorted_lines, sorted_lens)
